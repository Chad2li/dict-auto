package io.github.chad2li.dictauto.base.properties;
...
public class DictAutoProperties {
    ...
    public DictAutoProperties() {
        this.defaultParentId = DictCst.DEFAULT_PARENT_ID;
        this.dictIdSuffix = DictCst.FIELD_DICT_ID_SUFFIX;
        this.dictItemSuffix = DictCst.FIELD_DICT_ITEM_SUFFIX;
    }
}
